...
import Studentportal from "../studentportal/page";
...
<div className="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
  ...
  <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
    <form className="space-y-6" action="#" method="POST">
      <div>
        <label htmlFor="email" className="block text-sm/6 font-medium text-gray-900">REGISTERATION NO#</label>
        <br />
        <p>AA00-AAA-000</p>
        <div className="mt-2">
      ...
      <div>
        <button type="submit" className="flex w-full justify-center rounded-md bg-indigo-600 px-3 py-1.5 text-sm/6 font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"><a href="studentportal">Sign in</a></button>
      </div>
    </form>

    <p className="mt-10 text-center text-sm/6 text-gray-500">
      For Faculty Portal
      <button><a href="facultylogin" className="font-semibold text-indigo-600 hover:text-indigo-500 ml-[10px]">Click Here</a></button>
    </p>
  </div>
</div>
</>
